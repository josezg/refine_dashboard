...
const TotalRevenue = () => {
  return (
    <Box p={4} flex={1} bgcolor="#fcfcfc" id="chart" display="flex" flexDirection="column" borderRadius="15px">
      <Typography fontSize={18} fontWeight={600} color="#11142b">Total revenue</Typography>
      ...
      <ReactApexChart series={TotalRevenueSeries} type="bar" heigh={310} options={TotalRevenueOptions}/>
    </Box>
  )
}
